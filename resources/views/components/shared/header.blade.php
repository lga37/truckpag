    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="sm:flex sm:items-center sm:ml-6">
            ...
            <div class="px-6 py-4 sm:block">
                <a href="{{ route('login') }}"
                class="ml-3 border-2 border-blue-500 rounded-lg font-bold text-blue-500 px-4 py-2
                transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white">Log in</a>
                <a href="{{ route('register') }}" class="ml-3 border-2 border-blue-500 rounded-lg font-bold text-blue-500 px-4 py-2
                transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white">Register</a>
            </div>
            @endauth
        </div>        
